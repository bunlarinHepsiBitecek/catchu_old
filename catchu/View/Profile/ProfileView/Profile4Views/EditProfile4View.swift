...
//        temp.displayProperties()
    ...
    @IBAction func changeProfilePhotoButtonTapped(_ sender: Any) {
        ...
        ImageVideoPickerHandler.shared.createActionSheetForImageChoiceProcess(inputRequest: .profilePicture, inputCallerViewController: .EditProfile4View)
...
//
//    func hideLoading() {
//        doneButton.setTitle(originalButtonText, for: .normal)
